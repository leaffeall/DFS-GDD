...
def train(model,  optimizer, scheduler, num_epochs, start_epoch):
    weights_part2 = torch.load(
        "/home/user/local/yw/DFS_1_10.pth")
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        # if (epoch+1) % 5 == 0:
        if (epoch+1) % 1 == 0:
            savepath = './checkpoints_gauss_DFS2/'+args.model+'/' + \
...
def main():
    ...
    sys.stdout = Logger(osp.join('./checkpoints_gauss_DFS2/'+args.model+'/' + \
